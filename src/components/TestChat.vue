    ...
    <ion-content>
        ...
        <ion-list>
            ...
            <ion-item v-for="comment in comments" :key="comment.id">
                ...
                <ion-thumbnail v-if="comment.mediaType === 'image'" slot="end" @click="openModal(comment)">
                    <img :src="comment.mediaUrl"/>
                </ion-thumbnail>
                <ion-icon v-if="comment.mediaType === 'video'" slot="end" name="videocam" @click="openModal(comment)"/>
            </ion-item>
        </ion-list>
